...
def train(train_loader, dev_loader, vocab, model, optimizer, scheduler, device, kf_index=0):
    ...
    for epoch in range(1, config.epoch_num + 1):
        ...
        with torch.no_grad():
            ...
            if kf_index == 0:
                logging.info("epoch: {}, f1 score: {}, P score:{}, R score: {}, "
                             "dev loss: {}".format(epoch, val_f1 ,p ,r, dev_loss))
            else:
                logging.info("Kf epoch: {}, epoch: {}, f1 score: {}, P score:{}, R score: {}, "
                             "dev loss: {}".format(kf_index, epoch, val_f1,p,r, dev_loss))
...
def test(dataset_dir, vocab, device, kf_index=0):
    ...
    if kf_index == 0:
        logging.info("final test loss: {}, f1 score: {}, P score:{}, R score: {}".format(test_loss, f1,p,r))
        ...
        logging.info("Kf epoch: {}, final test loss: {}, f1 score: {}, P score:{}, R score: {}".format(kf_index, test_loss, f1, p, r))
    return test_loss, f1
