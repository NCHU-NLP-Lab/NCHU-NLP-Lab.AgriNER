...
def train(train_loader, dev_loader, model, optimizer, scheduler, model_dir):
    ...
    for epoch in range(1, config.epoch_num + 1):
        ...
        logging.info("Epoch: {}, dev loss: {}, f1 score: {}, P score:{}, R score: {}".format(epoch, val_metrics['loss'], val_f1, p, r))
...
def evaluate(dev_loader, model, mode='dev'):
    ...
    if (config.use_model == 'bert'):
        ...
        # tokenizer = AlbertTokenizer.from_pretrained(config.albert_model, do_lower_case=True)
