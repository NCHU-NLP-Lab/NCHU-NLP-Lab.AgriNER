...
def test():
    ...
    test_dataset = NERDataset(word_test, label_test, config, is_train=False)
...
def run():
    ...
    # build dataset
    train_dataset = NERDataset(word_train, label_train, config, is_train=True)
    dev_dataset = NERDataset(word_dev, label_dev, config, is_train=False)
    logging.info("--------Dataset Build!--------")
    # get dataset size
